      ...
      <div style={{...cardStyle}}>
        ...
        >
          {[
            {
              label: "Total Miles",
              value: `${route.total_miles?.toLocaleString()} mi`,
            },
            {
              label: "Total Days",
              value: `${summary?.total_days ?? logDays?.length} days`,
            },
            {
            ...
            >
              <div style={{flex: 1}}>
                ...
                <div style={{fontSize: 11, color: "#6b7280"}}>
                  Arrives {formatHour(stop.arrival_hour)} ·{" "}
                  {stop.miles_from_start} mi from start ·{" "}
